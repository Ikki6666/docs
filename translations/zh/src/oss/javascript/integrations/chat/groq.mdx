...
[Groq](https://groq.com/) 提供由 LPU™ AI 推理技术驱动的高速 AI 推理能力。

可用模型列表请参见 [Groq model documentation](https://console.groq.com/docs/models)。

本文将帮助你开始使用 Groq [chat models](/oss/langchain/models)。如需查看 `ChatGroq` 全部功能与配置的详细文档，请参见 [API reference](https://reference.langchain.com/javascript/langchain-groq/ChatGroq)。
...
要访问 ChatGroq 模型，你需要创建 Groq 账号、获取 API key，并安装 `@langchain/groq` 集成包。

### 凭证

要使用 Groq API，请在 [Groq console](https://console.groq.com/keys) 中创建 API key。
然后，你可以在终端中将 API key 设置为环境变量：
...
如需查看 `ChatGroq` 全部功能与配置的详细文档，请前往 [API reference](https://reference.langchain.com/javascript/langchain-groq/ChatGroq)。
