...
description: "集成 GoogleGenerativeAIEmbeddings embedding model 以在 LangChain JavaScript 中使用。"
---

本文将帮助你开始在 LangChain 中使用 Google Generative AI [embedding models](/oss/integrations/embeddings)。如需查看 `GoogleGenerativeAIEmbeddings` 的特性和配置选项详情，请参阅 [API reference](https://reference.langchain.com/javascript/langchain-google-genai/GoogleGenerativeAIEmbeddings)。

## 概览

### 集成信息

| Class | Package | Local | [Py support](https://python.langchain.com/docs/integrations/embeddings/google_generative_ai/) | Downloads | Version |
| :--- | :--- | :---: | :---: |  :---: | :---: |
| [`GoogleGenerativeAIEmbeddings`](https://reference.langchain.com/javascript/langchain-google-genai/GoogleGenerativeAIEmbeddings) | [`@langchain/google-genai`](https://npmjs.com/@langchain/google-genai) | ❌ | ✅ | ![NPM - Downloads](https://img.shields.io/npm/dm/@langchain/google-genai?style=flat-square&label=%20&) | ![NPM - Version](https://img.shields.io/npm/v/@langchain/google-genai?style=flat-square&label=%20&) |

## 设置

要访问 Google Generative AI embedding models，需要注册 Google AI 账号、获取 API key，并安装 `@langchain/google-genai` 集成包。

### 凭据

在这里获取 API key：[ai.google.dev/tutorials/setup](https://ai.google.dev/tutorials/setup)。

然后，将你的 key 设置为名为 `GOOGLE_API_KEY` 的环境变量：
...
LangChain 的 `GoogleGenerativeAIEmbeddings` 集成位于 `@langchain/google-genai` 包中。你可能也会想安装官方 SDK：
...
如需查看 `GoogleGenerativeAIEmbeddings` 的全部特性和配置详情，请参阅 [API reference](https://reference.langchain.com/javascript/langchain-google-genai/GoogleGenerativeAIEmbeddings)。
