...
<CardGroup cols={3}>
  ...
  <Card title="Generative UI" icon="wand" href="/oss/langchain/frontend/generative-ui-overview">
    渲染 agent 生成的界面，覆盖从受控到声明式再到开放式这一完整范围。
  </Card>
</CardGroup>
...
| 将状态渲染为应用，而不是聊天 | [Structured output](/oss/langchain/frontend/structured-output)、[generative UI](/oss/langchain/frontend/generative-ui-overview) 和 [Deep Agents frontend patterns](/oss/deepagents/frontend/overview) |
