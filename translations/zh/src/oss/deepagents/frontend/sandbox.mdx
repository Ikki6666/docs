...
- **在上线前加上 guardrail**。为自治 coding agent 配置 [rate limits](/oss/deepagents/fault-tolerance#rate-limiting)、[error handling](/oss/deepagents/fault-tolerance#error-handling) 和 [data privacy](/oss/deepagents/going-to-production#data-privacy) middleware。
