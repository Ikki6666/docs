---
title: "Digitalocean gradient AI platform 集成"
description: "使用 LangChain Python 集成 Digitalocean gradient AI platform。"
---

这将帮助您开始使用 DigitalOcean Gradient [chat models](/oss/langchain/models)。
...
在 DigitalOcean 上创建账户，从 Gradient Platform 获取 `DIGITALOCEAN_INFERENCE_KEY` API 密钥，并安装 `langchain-gradient` 集成包。
