...
[Browserbase](https://browserbase.com) 是一个开发者平台，可稳定地运行、管理并监控无头浏览器。
...
- 从 [browserbase.com](https://browserbase.com) 获取 API key 和 Project ID，并将其设置为环境变量 `BROWSERBASE_API_KEY`、`BROWSERBASE_PROJECT_ID`
