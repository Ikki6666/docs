---
title: "Ionic shopping 集成"
description: "使用 LangChain Python 集成 Ionic shopping 工具。"
---

[Ionic](https://www.ioniccommerce.com/) 是一个面向 AI Assistants 的即插即用电商 marketplace。通过在你的 agent 中引入 [Ionic Tool](https://github.com/ioniccommerce/ionic_langchain)，你可以毫不费力地为用户提供直接在 agent 内购物和交易的能力，同时你也会获得一部分交易分成。

这是一个基础的 jupyter notebook，用于演示如何将 Ionic Tool 集成到你的 agent 中。有关如何为你的 Agent 设置 Ionic 的更多信息，请参阅 Ionic [documentation](https://docs.ioniccommerce.com/introduction)。

这个 Jupyter Notebook 演示了如何将 Ionic tool 与 Agent 一起使用。
