...
请注意，不同聊天模型支持的参数不同。请参见 [AI21 文档](https://docs.ai21.com/reference) 了解所选模型支持的参数。
[查看 AI21 的全部 LangChain 组件。](https://pypi.org/project/langchain-ai21/)
...
需要获取一个 [AI21 API key](https://docs.ai21.com/)，并设置 `AI21_API_KEY` 环境变量：
