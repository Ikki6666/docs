...
Vertex AI 提供 Google Cloud 中可用的全部基础模型，例如 `gemini-3.1-pro-preview`、`gemini-3.7-flash` 等。完整且最新的可用模型列表，请参见 [VertexAI documentation](https://cloud.google.com/vertex-ai/generative-ai/docs/models)。
