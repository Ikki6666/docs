...
description: "使用 LangChain Python 与 Google cloud storage file document loader 集成。"
---
...
本页介绍如何从 `Google Cloud Storage (GCS)` 文件对象，也就是 `blob`，中加载 document 对象。
...
如果你希望使用其他 loader，也可以提供自定义函数，例如：
