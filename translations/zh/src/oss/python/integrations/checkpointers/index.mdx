---
title: "Checkpointer 集成"
sidebarTitle: Checkpointers
description: "使用 LangGraph 持久化的 checkpointer 后端集成。"
---

Checkpointer 为 LangGraph 提供[persistence](/oss/langgraph/persistence)能力，让智能体能够在多轮交互之间保存并恢复状态。

如果你想为自定义存储后端实现自己的 checkpointer，请参阅[构建自定义 checkpointer](/oss/langgraph/checkpointers#build-a-custom-checkpointer)。
