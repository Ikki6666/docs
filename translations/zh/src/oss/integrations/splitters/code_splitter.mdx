---
title: "代码分割 text splitter 集成指南"
---

@[RecursiveCharacterTextSplitter] 内置了预设的分隔符列表，适用于在特定编程语言中进行[文本分割](/oss/integrations/splitters/)。

:::python
支持的语言保存在 `langchain_text_splitters.Language` 枚举中，包括：
...
如果你想查看某种语言对应的分隔符列表，可以把这个枚举中的值传给：
```python
RecursiveCharacterTextSplitter.get_separators_for_language
```

如果你想实例化一个针对特定语言定制的 splitter，可以把这个枚举中的值传给：
```python
...
:::
:::js
下面是使用 Python text splitter 的示例：
...
## TS
:::python
下面是使用 TypeScript text splitter 的示例：
...
## Markdown
:::python
下面是使用 Markdown text splitter 的示例：
...
## Solidity
:::python
下面是使用 Solidity text splitter 的示例：
...
## Haskell
:::python
下面是使用 Haskell text splitter 的示例：
...
## PowerShell
:::python
下面是使用 PowerShell text splitter 的示例：
